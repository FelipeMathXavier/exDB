...
public class GUIListarNome extends javax.swing.JFrame {

    /**
     * Creates new form GUIListarNome
     */
    public GUIListarNome() {
        initComponents();
        listaProdutos();
    }
    ...
    private void initComponents() {
        ...
        tabelaProdutoNome = new javax.swing.JTable();
        ...
        tabelaProdutoNome.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tabelaProdutoNome.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelaProdutoNomeMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(tabelaProdutoNome);
    ...
    private void tabelaProdutoNomeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaProdutoNomeMouseClicked

    }//GEN-LAST:event_tabelaProdutoNomeMouseClicked
    ...
    private void listarCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarCategoriaActionPerformed
        ...
        try {
            ...
            Logger.getLogger(GUIListarNome.class.getName()).log(Level.SEVERE, null, ex);
        }
        janela.setVisible(true);
        this.dispose();
    ...
    public void listaProdutos () {
        try{
            List <Produto> produtos = ProdutoDAO.buscarProduto("nome"); 
            DefaultTableModel modelo = (DefaultTableModel) tabelaProdutoNome.getModel(); 
            modelo.setNumRows(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIListarNome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIListarNome().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabelaProdutoNome;
