...
public class GUIListarMaiorMenorQuantidade extends javax.swing.JFrame {

    /**
     * Creates new form GUIListarMaiorQuantidade
     */
    public GUIListarMaiorMenorQuantidade() {
        initComponents();
        listaProdutos();
    }
    ...
    private void listarCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarCategoriaActionPerformed
        ...
        try {
            ...
            Logger.getLogger(GUIListarMaiorMenorQuantidade.class.getName()).log(Level.SEVERE, null, ex);
        }
        janela.setVisible(true);
        this.dispose();
    ...
    public void listaProdutos(){
        try{
            List <Produto> produtos = ProdutoDAO.buscarProduto("maiorMenorQuantidade"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIListarMaiorMenorQuantidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIListarMaiorMenorQuantidade().setVisible(true);
            }
        });
    }
